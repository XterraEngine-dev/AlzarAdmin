...
(function () {
    ...
    app.controller('ctrl', function ($scope, $firebaseAuth, $firebaseArray, $http) {
        ...
        $scope.agregarCodigoCondomino = function (condomino) {


            var numeroCondomino = condomino.numero;
            console.log(condomino.numero);
            console.log(uidAmenidad);


            window.open('reservar-admin.html?id=' + uidAmenidad + '&uid_condomino=' + uidCondominio + numeroCondomino, '_blank');

        }

        $scope.agregarCodigoCondominoBoleta = function (condomino) {
            ...
            window.open('mis_reservas.html?' + 'uid_condomino=' + uidCondominio + numeroCondomino + '&uid_condominio=' + uidCondominio, '_blank');
        ...
        $scope.modificarFoto = function (i) {
            $scope.editar = i;
            $scope.actualRef = ref.child($scope.condominioSeleccionado).child(i.$id).child("foto")
        ...
        $scope.AgregarReserva = function (i) {
        ...
        $scope.AgregarBoleta = function () {
            $("#boletaModal").modal("open");
            //console.log(i.codigo);
            //console.log(i.$id);
            //uidAmenidad = i.$id;

            //id uid del condominio
        ...
        $scope.editarCondiciones = function (id, propiedad) {
            $scope.editar = id;
            $scope.propiedad = propiedad;
            if ($scope.editar[propiedad]) {
                tinymce.activeEditor.setContent($scope.editar[propiedad]);
            } else {
